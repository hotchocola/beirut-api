...
//   @Query(value = "SELECT id FROM CandidatePosition WHERE id = ?1 and markForDelete = ?2", nativeQuery = true)
//   List<CandidatePosition> findByIDAndMarkForDelete(String id, boolean bool);
//
//   @Query(value = "SELECT position_id FROM CandidatePosition WHERE position_id = ?1 and markForDelete = ?2", nativeQuery = true)
